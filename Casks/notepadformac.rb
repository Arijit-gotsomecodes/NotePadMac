...
on_intel do
    ...
    url "https://github.com/Arijit-gotsomecodes/NotePadMac/releases/download/app-v#{version}/NotepadMac_#{version}_x64.dmg"
  end
  on_arm do
    sha256 "9081f4767dc396f71ccd5e2819d7a7ce42ef35bee7a7e98708814a6bbbde6259"
    url "https://github.com/Arijit-gotsomecodes/NotePadMac/releases/download/app-v#{version}/NotepadMac_#{version}_aarch64.dmg"
  end

  name "NotepadMac"
  desc "A modern, fast, and lightweight Notepad for macOS"
  homepage "https://github.com/Arijit-gotsomecodes/NotePadMac"
